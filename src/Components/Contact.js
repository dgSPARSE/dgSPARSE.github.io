...
const data = [
  createData(
    ...
    "https://nicsefc.ee.tsinghua.edu.cn/people/guohao-dai/"
  ),
  createData(
    "Zhongming Yu",
    "University of California, San Diego",
    "https://fishmingyu.github.io/"
  ),
  createData(
    "Guyue Huang",
    "University of California, Santa Barbara",
    "https://hgyhungry.github.io/"
  ),
  createData("Hengrui Zhang", "Princeton University"),
  createData(
    "Tianyu Fu",
    "Tsinghua University",
    "http://nicsefc.ee.tsinghua.edu.cn/people/TianyuFu"
  ),
  createData(
    "Genghan Zhang",
    "Tsinghua University",
    "https://zhang677.github.io/"
  ),
  createData("Shang Yang", "Tsinghua University"),
  createData(
    "Jiaming Xu",
    "Shanghai Jiao Tong University",
    "https://mathscode.github.io/"
  ),
  ...
  createData(
    "Yu Wang",
    "Tsinghua University",
    "http://nicsefc.ee.tsinghua.edu.cn/people/YuWang"
  ),
];
